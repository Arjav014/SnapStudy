...
const ProcessingContainer = () => {
  ...
  const { processedData, processingStage } = useFileStore();
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-orange-50 p-4 rounded-lg border border-orange-200">
              ...
              <p className="text-gray-700">
                Your document summaries are ready. Click to view detailed
                summaries of your materials.
              </p>
              <button
            ...
            <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
              ...
              <p className="text-gray-700">
                All formulas extracted from your documents are organized here
                for quick reference.
              </p>
              <button
            ...
            >
              ...
              <div className="p-4 border border-gray-200 rounded">
                ...
                <p className="text-gray-700 mb-3">
                  This summary combines insights from all your uploaded
                  documents. It provides an integrated overview of the main
                  themes, concepts, and important information.
                </p>

                <h4 className="font-medium text-md mt-4 mb-2">Main Themes</h4>
                <p className="text-gray-700 mb-3">
                  The documents collectively address several interconnected
                  topics. The primary focus appears to be on [theme description
                  here], with significant attention to [secondary theme].
                  Several documents emphasize the importance of [important
                  concept].
                </p>
                ...
                <p className="text-gray-700 mb-3">
                  Across all materials, important insights include the
                  relationship between [concept A] and [concept B]. The analysis
                  suggests that [key finding]. Additionally, multiple sources
                  confirm [important fact or conclusion].
                </p>

                <h4 className="font-medium text-md mt-4 mb-2">Applications</h4>
                <p className="text-gray-700">
                  These concepts can be applied to [practical application]. The
                  methodologies described are particularly relevant for
                  [specific use case]. Further exploration is recommended in the
          ...
          <div className="bg-white rounded-lg shadow-xl p-6 max-w-2xl w-full mx-4">
            ...
            >
              ...
              <div className="p-4 border border-gray-200 rounded">
                ...
                <p className="text-gray-700 mb-3">
                  All formulas extracted from your documents are listed below
                  for easy reference.
                </p>
                ...
                <div className="bg-gray-50 p-3 rounded mb-3">
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Pressure times volume equals number of moles times gas
                ...
                <div className="bg-gray-50 p-3 rounded mb-3">
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Change in entropy equals heat transfer divided by
                    temperature
                  </p>
                </div>
